...
GENERIC_DOMAINS = {
    ...
    "chemistry": (
        "chemistry", "chemical", "synthesis", "catalysis", "catalyst", "catalysts",
        "electrocatalysis", "electrocatalytic", "electrocatalyst", "electrocatalysts",
        "electro-oxidation", "electrooxidation", "urea oxidation", "molecule",
    ),
    ...
    "energy": (
        "energy", "battery", "solar", "photovoltaic", "fuel cell", "power grid",
        "electrochemical", "electro-oxidation", "electrooxidation", "urea oxidation",
        "hydrogen production", "energy conversion",
    ),
    ...
    "materials_science": (
        "materials science", "nanomaterial", "polymer", "alloy", "thin film",
        "semiconductor", "nickel-based catalyst", "nickel-based catalysts",
    ),
